                                ...
                                <div class="flex justify-between mb-8">
                                    <div>
                                        <div class="relative inline-block text-left">
                                            ...
                                            <div id="forum-menu-latest" class="z-10 hidden origin-top-left absolute left-0 border mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
